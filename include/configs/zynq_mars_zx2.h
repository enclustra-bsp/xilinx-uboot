...
#define QSPI_RESCUELINUX_SIZE     0x00400000   // size 3MB
#define QSPI_RESCUEDTB_OFFSET     0x00A00000   // Storage for Linux Devicetree
...
#define QSPI_RESCUEROOTFS_OFFSET  0x00B00000   // Storage for Linux Root FS
