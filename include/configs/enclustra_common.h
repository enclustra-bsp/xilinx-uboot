...
#define CONFIG_EXTRA_ENV_SETTINGS               \
    ...
    "bootimage_loadaddr=0x4000000\0"		\
                                                \
    "qspi_bootimage_offset=0x2000000\0"         \
    "bootimage_size=0x2000000\0"                \
    "qspi_bootscript_offset=0x01f80000\0"       \
                                                \
    "def_args=console=ttyPS0,115200 rw earlyprintk\0"\
    "mmc_args=setenv bootargs ${def_args} rootwait root=/dev/mmcblk${mmcdev}p2\0"\
    "nand_args=setenv bootargs ${def_args} root=/dev/ram0 rw\0"\
    "qspi_args=setenv bootargs ${def_args} root=/dev/ram0 rw\0"\
